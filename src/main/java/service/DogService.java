...
public class DogService implements IService<Dog> {
    ...
    @Override
    public void add(Dog entity) throws SQLException, IllegalAccessException {
        dao.save(entity);
    }
    ...
    public List<String> getAllCommands(int id) throws SQLException, NoSuchFieldException,
        ...
        return dao.getOne(id, Dog.class).getCommands();
    }


    @Override
    public void addNewCommand(Dog entity, String command) throws SQLException, IllegalAccessException {
    ...
    @Override
    public List<Dog> getAllAnimals() throws SQLException, NoSuchFieldException, InvocationTargetException,
            NoSuchMethodException, InstantiationException, IllegalAccessException {
        return dao.getAll(Dog.class).stream().sorted(new AnimalBirthDateComparator()).toList();
    }

    @Override
    public int getTotalAnimals() throws SQLException, NoSuchFieldException, InvocationTargetException,
            NoSuchMethodException, InstantiationException, IllegalAccessException {
        return dao.getAll(Dog.class).size();
    }
}
